...
public class Spirographone extends Processor {
    ...
    public Spirographone(final Context context,
        ...
        super(context, input, output, null, new HashSet<>(asList(
                Parameter.of("externalCircleRadius", "Ext. radius", 1,
                        "External circle radius", DataType.INTEGER,
                        true, 50),
                Parameter.of("internalCircleRadius", "Int. radius", 2,
                        "Internal circle radius", DataType.INTEGER,
                        true, 10),
                Parameter.of("penOffset", "Pen offset", 3,
                        "Pen offset", DataType.INTEGER,
                        true, 3),
                Parameter.of("delta", "Iteration delta", 4,
                        "Iteration delta", DataType.INTEGER,
                        true, 5),
                Parameter.of("spaceMillis", "Space", 5,
                        "Space between notes, in millis", DataType.INTEGER,
                        true, 200),
                Parameter.of("minOctave", "Min. octave", 6,
                        "Minimum octave", DataType.INTEGER,
                        true, 3),
                Parameter.of("maxOctave", "Max. octave", 7,
                        "Maximum octave", DataType.INTEGER,
                        true, 5),
                Parameter.of("root", "Root", 8,
                        "Root note", DataType.NOTE,
                        true, Note.E),
                Parameter.of("scale", "Scale", 9,
